#include<iostream>
using namespace std;
int find_PerfectSum(int *arr,int index,int sum,int n){
...
return find_PerfectSum(arr, index+1,sum,n)+find_PerfectSum(arr,index,sum-arr[index],n);
...
int main()
{
    ...
    int sum;
    cout<<" enter what you went to find out :"<<endl;
    cin>>sum;
    cout<<" the perfect sum is present at :"<<find_PerfectSum(arr,0,sum,n)<<": time in the given array :"<<endl;
    return 0;
...
int main() {
    ...
    cout<<" we are finding the diameter of tree ::"<<endl;
    cout<<" the diameter of  the given tree structure is  ::" <<endl<<find_diameter(root)<<endl;
    return 0;
}
/*
